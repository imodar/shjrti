          ...
          <div className="relative bg-white/30 dark:bg-gray-800/30 backdrop-blur-xl border border-white/40 dark:border-gray-600/40 rounded-2xl py-1 px-3 shadow-xl ring-1 ring-white/10 dark:ring-gray-500/10">
            <div className="flex items-center justify-between gap-2 sm:gap-4 md:gap-8">
              ...
              <div className="flex-1 px-2">
                 ...
                 {/* Compact Actions */}
                 <div className="flex items-center ltr:justify-start rtl:justify-end gap-1 sm:gap-2">
                   ...
                   <button onClick={() => navigate(`/family-tree-view?family=${familyId}`)} className={`group relative flex items-center gap-1 sm:gap-2 px-2 sm:px-4 py-2 sm:py-2.5 text-xs sm:text-sm font-medium rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 ${isTreeViewActive ? "text-white bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 overflow-hidden" : "text-slate-700 dark:text-slate-300 bg-white/80 dark:bg-slate-800/80 hover:bg-white dark:hover:bg-slate-800 border border-slate-200/50 dark:border-slate-700/50 hover:border-slate-300 dark:hover:border-slate-600 backdrop-blur-sm"}`}>
                     ...
                     <TreePine className={`h-3 w-3 sm:h-4 sm:w-4 ${isTreeViewActive ? 'relative z-10' : 'text-emerald-500 group-hover:text-emerald-600 transition-colors duration-300'}`} />
                   ...
                   <button onClick={() => navigate(`/family-gallery?family=${familyId}`)} className={`group relative flex items-center gap-1 sm:gap-2 px-2 sm:px-4 py-2 sm:py-2.5 text-xs sm:text-sm font-medium rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 ${isGalleryActive ? "text-white bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 overflow-hidden" : "text-slate-700 dark:text-slate-300 bg-white/80 dark:bg-slate-800/80 hover:bg-white dark:hover:bg-slate-800 border border-slate-200/50 dark:border-slate-700/50 hover:border-slate-300 dark:hover:border-slate-600 backdrop-blur-sm"}`}>
                     ...
                     <Image className={`h-3 w-3 sm:h-4 sm:w-4 ${isGalleryActive ? 'relative z-10' : 'text-purple-500 group-hover:text-purple-600 transition-colors duration-300'}`} />
                    ...
                    <button onClick={() => navigate(`/family-statistics?family=${familyId}`)} className={`group relative flex items-center gap-1 sm:gap-2 px-2 sm:px-4 py-2 sm:py-2.5 text-xs sm:text-sm font-medium rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 ${isStatisticsActive ? "text-white bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 overflow-hidden" : "text-slate-700 dark:text-slate-300 bg-white/80 dark:bg-slate-800/80 hover:bg-white dark:hover:bg-slate-800 border border-slate-200/50 dark:border-slate-700/50 hover:border-slate-300 dark:hover:border-slate-600 backdrop-blur-sm"}`}>
                      ...
                      <Star className={`h-3 w-3 sm:h-4 sm:w-4 ${isStatisticsActive ? 'relative z-10' : 'text-amber-500 group-hover:text-amber-600 transition-colors duration-300'}`} />
                    ...
                    <button onClick={onSettingsClick} className={`group relative flex items-center gap-1 sm:gap-2 px-2 sm:px-4 py-2 sm:py-2.5 text-xs sm:text-sm font-medium rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 ${isSettingsOpen ? "text-white bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 overflow-hidden" : "text-slate-700 dark:text-slate-300 bg-white/80 dark:bg-slate-800/80 hover:bg-white dark:hover:bg-slate-800 border border-slate-200/50 dark:border-slate-700/50 hover:border-slate-300 dark:hover:border-slate-600 backdrop-blur-sm"}`}>
                     ...
                     <Settings className={`h-3 w-3 sm:h-4 sm:w-4 ${isSettingsOpen ? 'relative z-10' : 'text-slate-500 group-hover:text-slate-600 dark:group-hover:text-slate-400'} group-hover:rotate-90 transition-all duration-300`} />
