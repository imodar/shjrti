              ...
              <div className="flex-1 px-2">
                 ...
                 <div className="flex items-center ltr:justify-start rtl:justify-end gap-0.5 md:gap-1 lg:gap-2 flex-wrap md:flex-nowrap overflow-x-auto scrollbar-hide">
                   <button onClick={() => navigate(`/family-builder-new?family=${familyId}`)} className={`group relative flex items-center gap-1 lg:gap-2 px-2 md:px-2.5 lg:px-4 py-2 md:py-2.5 lg:py-2.5 text-[10px] lg:text-sm font-medium rounded-lg md:rounded-xl shadow-md md:shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex-shrink-0 ${isTreeBuilderActive ? "text-white bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 overflow-hidden" : "text-slate-700 dark:text-slate-300 bg-white/80 dark:bg-slate-800/80 hover:bg-white dark:hover:bg-slate-800 border border-slate-200/50 dark:border-slate-700/50 hover:border-slate-300 dark:hover:border-slate-600 backdrop-blur-sm"}`}>
                     ...
                     <Users className={`h-4 w-4 lg:h-4 lg:w-4 ${isTreeBuilderActive ? 'relative z-10' : 'text-emerald-500 group-hover:text-emerald-600 transition-colors duration-300'}`} />
                   ...
                   <button onClick={() => navigate(`/family-tree-view?family=${familyId}`)} className={`group relative flex items-center gap-1 lg:gap-2 px-2 md:px-2.5 lg:px-4 py-2 md:py-2.5 lg:py-2.5 text-[10px] lg:text-sm font-medium rounded-lg md:rounded-xl shadow-md md:shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex-shrink-0 ${isTreeViewActive ? "text-white bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 overflow-hidden" : "text-slate-700 dark:text-slate-300 bg-white/80 dark:bg-slate-800/80 hover:bg-white dark:hover:bg-slate-800 border border-slate-200/50 dark:border-slate-700/50 hover:border-slate-300 dark:hover:border-slate-600 backdrop-blur-sm"}`}>
                     ...
                     <TreePine className={`h-4 w-4 lg:h-4 lg:w-4 ${isTreeViewActive ? 'relative z-10' : 'text-emerald-500 group-hover:text-emerald-600 transition-colors duration-300'}`} />
                   ...
                   <button onClick={() => navigate(`/family-gallery?family=${familyId}`)} className={`group relative flex items-center gap-1 lg:gap-2 px-2 md:px-2.5 lg:px-4 py-2 md:py-2.5 lg:py-2.5 text-[10px] lg:text-sm font-medium rounded-lg md:rounded-xl shadow-md md:shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex-shrink-0 ${isGalleryActive ? "text-white bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 overflow-hidden" : "text-slate-700 dark:text-slate-300 bg-white/80 dark:bg-slate-800/80 hover:bg-white dark:hover:bg-slate-800 border border-slate-200/50 dark:border-slate-700/50 hover:border-slate-300 dark:hover:border-slate-600 backdrop-blur-sm"}`}>
                     ...
                     <Image className={`h-4 w-4 lg:h-4 lg:w-4 ${isGalleryActive ? 'relative z-10' : 'text-purple-500 group-hover:text-purple-600 transition-colors duration-300'}`} />
                    ...
                    <button onClick={() => navigate(`/family-statistics?family=${familyId}`)} className={`group relative flex items-center gap-1 lg:gap-2 px-2 md:px-2.5 lg:px-4 py-2 md:py-2.5 lg:py-2.5 text-[10px] lg:text-sm font-medium rounded-lg md:rounded-xl shadow-md md:shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex-shrink-0 ${isStatisticsActive ? "text-white bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 overflow-hidden" : "text-slate-700 dark:text-slate-300 bg-white/80 dark:bg-slate-800/80 hover:bg-white dark:hover:bg-slate-800 border border-slate-200/50 dark:border-slate-700/50 hover:border-slate-300 dark:hover:border-slate-600 backdrop-blur-sm"}`}>
                      ...
                      <Star className={`h-4 w-4 lg:h-4 lg:w-4 ${isStatisticsActive ? 'relative z-10' : 'text-amber-500 group-hover:text-amber-600 transition-colors duration-300'}`} />
                    ...
                    <button onClick={() => navigate(`/family-suggestions?family=${familyId}`)} className={`group relative flex items-center gap-1 lg:gap-2 px-2 md:px-2.5 lg:px-4 py-2 md:py-2.5 lg:py-2.5 text-[10px] lg:text-sm font-medium rounded-lg md:rounded-xl shadow-md md:shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex-shrink-0 ${isSuggestionsActive ? "text-white bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700" : "text-slate-700 dark:text-slate-300 bg-white/80 dark:bg-slate-800/80 hover:bg-white dark:hover:bg-slate-800 border border-slate-200/50 dark:border-slate-700/50 hover:border-slate-300 dark:hover:border-slate-600 backdrop-blur-sm"}`}>
                      ...
                      <Lightbulb className={`h-4 w-4 lg:h-4 lg:w-4 ${isSuggestionsActive ? 'relative z-10' : 'text-orange-500 group-hover:text-orange-600 transition-colors duration-300'}`} />
                    ...
                    <button onClick={onSettingsClick} className={`group relative flex items-center gap-1 lg:gap-2 px-2 md:px-2.5 lg:px-4 py-2 md:py-2.5 lg:py-2.5 text-[10px] lg:text-sm font-medium rounded-lg md:rounded-xl shadow-md md:shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex-shrink-0 ${isSettingsOpen ? "text-white bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 overflow-hidden" : "text-slate-700 dark:text-slate-300 bg-white/80 dark:bg-slate-800/80 hover:bg-white dark:hover:bg-slate-800 border border-slate-200/50 dark:border-slate-700/50 hover:border-slate-300 dark:hover:border-slate-600 backdrop-blur-sm"}`}>
                     ...
                     <Settings className={`h-4 w-4 lg:h-4 lg:w-4 ${isSettingsOpen ? 'relative z-10' : 'text-slate-500 group-hover:text-slate-600 dark:group-hover:text-slate-400'} group-hover:rotate-90 transition-all duration-300`} />
