                ...
                {/* Compact Actions */}
                 <div className="flex items-center justify-center gap-2">
                   <button 
                     ...
                     className="group relative flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 overflow-hidden"
                   >
