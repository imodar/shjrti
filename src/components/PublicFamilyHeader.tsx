              ...
              <div className="flex-1 px-2">
                <div className="flex items-center justify-center gap-2">
                  ...
                  >
                    ...
                    <span className={`hidden sm:inline ${activeSection === 'overview' ? 'relative z-10' : ''}`}>نبذة</span>
                    {activeSection === 'overview' && <div className="absolute -top-1 -right-1 w-2 h-2 bg-yellow-400 rounded-full opacity-0 group-hover:opacity-100 animate-ping transition-opacity duration-300"></div>}
                    {activeSection !== 'overview' && <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/10 to-teal-500/10 opacity-0 group-hover:opacity-100 rounded-xl transition-opacity duration-300"></div>}
                  </button>
                  ...
                  >
                    {activeSection === 'tree' && <div className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>}
                    ...
                    <span className={`hidden sm:inline ${activeSection === 'tree' ? 'relative z-10' : ''}`}>الشجرة</span>
                    {activeSection === 'tree' && <div className="absolute -top-1 -right-1 w-2 h-2 bg-yellow-400 rounded-full opacity-0 group-hover:opacity-100 animate-ping transition-opacity duration-300"></div>}
                    {activeSection !== 'tree' && <div className="absolute inset-0 bg-gradient-to-r from-teal-500/10 to-cyan-500/10 opacity-0 group-hover:opacity-100 rounded-xl transition-opacity duration-300"></div>}
                  </button>
                  ...
                  >
                    {activeSection === 'statistics' && <div className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>}
                    ...
                    <span className={`hidden sm:inline ${activeSection === 'statistics' ? 'relative z-10' : ''}`}>الإحصائيات</span>
                    {activeSection === 'statistics' && <div className="absolute -top-1 -right-1 w-2 h-2 bg-yellow-400 rounded-full opacity-0 group-hover:opacity-100 animate-ping transition-opacity duration-300"></div>}
                    {activeSection !== 'statistics' && <div className="absolute inset-0 bg-gradient-to-r from-amber-500/10 to-orange-500/10 opacity-0 group-hover:opacity-100 rounded-xl transition-opacity duration-300"></div>}
                  </button>
                  ...
                  {showGallery && (
                    ...
                    >
                      {activeSection === 'gallery' && <div className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>}
                      ...
                      <span className={`hidden sm:inline ${activeSection === 'gallery' ? 'relative z-10' : ''}`}>الألبوم</span>
                      {activeSection === 'gallery' && <div className="absolute -top-1 -right-1 w-2 h-2 bg-yellow-400 rounded-full opacity-0 group-hover:opacity-100 animate-ping transition-opacity duration-300"></div>}
                      {activeSection !== 'gallery' && <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 to-pink-500/10 opacity-0 group-hover:opacity-100 rounded-xl transition-opacity duration-300"></div>}
                    </button>
                  )}
                </div>
              </div>
