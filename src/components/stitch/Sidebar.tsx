...
export const StitchSidebar: React.FC<StitchSidebarProps> = ({
  ...
  return (
    <>
      ...
      <aside className={cn(
        'bg-white dark:bg-slate-900 flex flex-col z-50 shadow-xl',
        // Desktop: static sidebar
        'lg:w-80 lg:relative lg:shadow-none lg:z-30 lg:border-e lg:border-slate-200 lg:dark:border-slate-800',
        // Mobile/Tablet: bottom sheet
        'max-lg:fixed max-lg:bottom-0 max-lg:left-0 max-lg:right-0 max-lg:rounded-t-2xl max-lg:max-h-[75vh]',
        // Animation
        isOpen 
