              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-1.5">
                    {isFounder && isDeceased ? (
                    ...
                    ) : thirdLine?.type === 'spouse' && !isDeceased ? (
                      ...
                      <span className="inline-flex items-center px-2 py-0.5 rounded-full bg-amber-50 dark:bg-amber-900/20 text-amber-600 text-[10px] font-bold border border-amber-500/20">
                        ...
                        {thirdLine?.type === 'death' ? thirdLine.text 
                          : thirdLine?.type === 'spouse' && isDeceased 
                            ? `${member.gender === 'female' ? t('member.died_female', 'متوفية') : t('member.died_male', 'متوفي')} ${(member as any).death_date?.split('-')[0] || ''}`
                            : isDeceased 
                              ? `${member.gender === 'female' ? t('member.died_female', 'متوفية') : t('member.died_male', 'متوفي')} ${(member as any).death_date?.split('-')[0] || ''}`
