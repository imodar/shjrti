            ...
            {step === 2 && (
              <div className="space-y-2">
                <div className="space-y-6">
                  {/* Marriage Section will appear based on first step completion */}
                </div>
              </div>
            )}
          </div>
            ...
            <div className="flex items-center justify-between gap-3">
              <div className="flex gap-2">
                {step > 1 && (
                  <Button
                    ...
                    className="flex items-center gap-2 bg-white/50 dark:bg-gray-700/50 hover:bg-white/70 dark:hover:bg-gray-700/70 border-white/30 dark:border-gray-600/30 text-gray-700 dark:text-gray-300"
                  >
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  variant="outline"
                  onClick={onClose}
                  className="bg-white/50 dark:bg-gray-700/50 hover:bg-white/70 dark:hover:bg-gray-700/70 border-white/30 dark:border-gray-600/30 text-gray-700 dark:text-gray-300"
                >
                  إلغاء
                </Button>
                ...
                {step < 2 ? (
                  <Button
                    type="button"
                    onClick={() => setStep(step + 1)}
                    disabled={!memberData.name || !memberData.gender}
                  ...
                  <Button
                    type="submit"
                    disabled={loading || !memberData.name || !memberData.gender}
                    className="bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white shadow-lg flex items-center gap-2"
                  >
                    {loading ? (
                      <>
