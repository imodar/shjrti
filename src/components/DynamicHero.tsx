...
const DynamicHero = () => {
  const [heroContent, setHeroContent] = useState({
    title: "اكتشف جذورك وابن تاريخ عائلتك",
    subtitle: "احفظ ذكريات عائلتك وشارك تاريخكم مع الأجيال القادمة. ابن شجرة عائلة تفاعلية وجميلة بطريقة سهلة ومبسطة.",
    cta_text: "ابدأ رحلتك المجانية"
  });
