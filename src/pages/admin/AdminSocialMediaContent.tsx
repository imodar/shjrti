...
import { Save, Share2, Upload, X } from "lucide-react";
...
export default function AdminSocialMediaContent() {
  ...
  return (
    <div className="space-y-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold mb-2">إعدادات المشاركة على السوشل ميديا</h2>
