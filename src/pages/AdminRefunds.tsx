...
import { ArrowLeft, RefreshCw, DollarSign, AlertTriangle, CheckCircle, XCircle, Search } from 'lucide-react';
...
export default function AdminRefunds() {
  ...
  const loadInvoices = async () => {
    ...
    try {
      ...
      // Get user profiles for each invoice
        ...
        <Card>
          ...
          <CardContent>
            <div className="relative">
              <Search className={`absolute top-3 ${isRTL ? 'start-3' : 'start-3'} w-4 h-4 text-muted-foreground`} />
              <Input
