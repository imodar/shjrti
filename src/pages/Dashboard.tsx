      ...
      <SubscriptionGuard>
        <div className="min-h-screen bg-gradient-to-br from-amber-50 via-emerald-50 to-teal-50 dark:from-amber-950 dark:via-emerald-950 dark:to-teal-950 relative overflow-hidden">
          ...
          <main className="relative z-10 pt-20">
              ...
              <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="text-center mb-16">
                  ...
                  <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                    {t('dashboard_subtitle', 'تاريخ عائلتك ينتظرك، والذكريات تتشوق لتدوينها')}
                  </p>
                </div>

                {/* Live Stats with Luxury Design - Matching Home Page */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                  {[
                    {
                      icon: <Users className="h-8 w-8" />,
                      title: t('stat_members', 'أفراد العائلة'),
                    ...
                    },
                    {
                      ...
                      title: t('stat_photos', 'الصور المحفوظة'),
                    ...
                    },
                    {
                      ...
                      title: t('stat_stories', 'القصص المكتوبة'),
                      value: displayedStories,
                    ...
                    <Card key={index} className="group relative overflow-hidden bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border-0 shadow-2xl hover:shadow-3xl transition-all duration-700 hover:-translate-y-4 hover:rotate-1">
                      {/* Luxury Card Background - Matching Home Page */}
                      ...
                      <div className={`absolute inset-0 bg-gradient-to-br from-transparent via-transparent ${stat.bgColor} group-hover:opacity-50 transition-all duration-700`}></div>
                      ...
                      <CardContent className="relative p-8 text-center">
                        ...
                        <div className="relative mb-6">
                          <div className={`absolute inset-0 bg-gradient-to-r ${stat.color} rounded-full blur-lg opacity-30 group-hover:opacity-50 transition-all duration-500 scale-110`}></div>
                          <div className={`relative inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br ${stat.color} rounded-full shadow-xl group-hover:shadow-2xl group-hover:scale-125 transition-all duration-500`}>
            ...
            {/* Features Section with Luxury Design - Matching Home Page */}
              ...
              <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="text-center mb-16">
                  <div className="inline-flex items-center gap-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white px-6 py-3 rounded-full text-sm font-medium mb-8 shadow-lg">
                    ...
                    {t('dashboard_features_badge', 'إدارة شاملة لتراثك')}
                    <Sparkles className="h-4 w-4" />
                  </div>
                  <h2 className="text-5xl md:text-6xl font-bold mb-8">
                    <span className="bg-gradient-to-r from-emerald-600 via-teal-600 to-amber-600 bg-clip-text text-transparent">
                      {t('dashboard_features_title', 'أدواتك المتقدمة')}
                    </span>
                  </h2>
                </div>
                  ...
                  {[
                    {
                      ...
                      title: t('feature_family_tree', 'شجرة العائلة'),
                      description: t('feature_family_tree_desc', 'استكشف وأضف أفراد عائلتك'),
                      link: '/family-tree-view',
                      color: "from-emerald-500 to-teal-500"
                    },
                    {
                      icon: <Plus className="h-8 w-8" />,
                      title: t('feature_add_member', 'إضافة فرد جديد'),
                      description: t('feature_add_member_desc', 'أضف أفراد جدد لعائلتك'),
                      link: '/family-builder',
                      color: "from-amber-500 to-orange-500"
                    },
                    {
                      icon: <Gem className="h-8 w-8" />,
                      title: t('feature_family_overview', 'نظرة شاملة'),
                      description: t('feature_family_overview_desc', 'اطلع على جميع أفراد العائلة'),
                      link: '/family-overview',
                      color: "from-pink-500 to-rose-500"
                    },
                    {
                      icon: <TrendingUp className="h-8 w-8" />,
                      title: t('feature_statistics', 'الإحصائيات'),
                      description: t('feature_statistics_desc', 'تحليل تفصيلي لبيانات عائلتك'),
                      link: '/family-statistics',
                      color: "from-purple-500 to-indigo-500"
                    },
                    {
                      icon: <Shield className="h-8 w-8" />,
                      title: t('feature_profile', 'الملف الشخصي'),
                      description: t('feature_profile_desc', 'إدارة حسابك وإعداداتك'),
                      link: '/profile',
                      color: "from-teal-500 to-cyan-500"
                    },
                    {
                      icon: <Infinity className="h-8 w-8" />,
                      title: t('feature_store', 'المتجر'),
                      description: t('feature_store_desc', 'اكتشف خطط الاشتراك المتاحة'),
                      link: '/store',
                      color: "from-violet-500 to-purple-500"
                    }
                  ].map((feature, index) => (
                    <Link key={index} to={feature.link}>
                      <Card className="group relative overflow-hidden bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border-0 shadow-2xl hover:shadow-3xl transition-all duration-700 hover:-translate-y-4 hover:rotate-1 cursor-pointer h-full">
                        ...
                        <CardContent className="relative p-8 text-center">
                          {/* Luxury Icon */}
                          <div className="relative mb-6">
                            <div className={`absolute inset-0 bg-gradient-to-r ${feature.color} rounded-full blur-lg opacity-30 group-hover:opacity-50 transition-all duration-500 scale-110`}></div>
                            <div className={`relative inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br ${feature.color} rounded-full shadow-xl group-hover:shadow-2xl group-hover:scale-125 transition-all duration-500`}>
                              <div className="text-white">
                                {feature.icon}
                              </div>
                            </div>
            ...
            {/* Inspirational Quote Section - Matching Home Page Style */}
            <section className="relative py-20 overflow-hidden">
              {/* Luxury Background */}
              ...
              <div className="container mx-auto px-4 relative z-10">
                <Card className="max-w-4xl mx-auto bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl border-0 shadow-2xl">
