        ...
        <DialogContent className="max-w-lg border-0 bg-gradient-to-br from-emerald-50/90 via-green-50/90 to-teal-50/90 dark:from-emerald-950/90 dark:via-green-950/90 dark:to-teal-950/90 backdrop-blur-xl shadow-2xl">
          ...
          <DialogFooter className="flex gap-4 pt-4">
            <Button
              ...
              variant="outline"
              className="flex-1 h-12 border-2 border-gray-300/50 hover:border-teal-300 hover:bg-teal-50 dark:hover:bg-teal-900/20 hover:font-semibold hover:text-teal-700 dark:hover:text-teal-100 transition-all duration-300 text-lg"
            >
              تخطي الآن
            </Button>
            <Button
