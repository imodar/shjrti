      ...
      <main className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Locked Slot - Show if trees used < max */}
            {treesUsed < maxTrees && families.length > 0 && (
              <div className="dashed-card bg-muted/50 rounded-3xl p-10 flex flex-col items-center justify-center text-center gap-4 opacity-70 cursor-not-allowed">
                ...
                <div>
                  <h4 className="text-lg font-bold text-muted-foreground">Locked Slot</h4>
                  <p className="text-muted-foreground text-xs mt-1">Upgrade your plan to unlock</p>
                </div>
                <button 
                  onClick={() => navigate('/plan-selection')}
                  className="mt-2 text-accent-gold text-xs font-black uppercase tracking-widest hover:underline"
                >
                  See Pricing
                </button>
              </div>
